...
export const zh = {
  ...
  'tool.title.runCordis': '运行插件',
  'tool.title.stopCordis': '停止插件',
  'tool.title.removeCordis': '移除插件',
  'tool.title.pwsh': '终端',
...
export const en = {
  ...
  'hero.headline': 'Start Your Marketing Engine in One Sentence',
  'hero.preview': 'Beta',
  'rail.aria': 'Conversation steps',
  'rail.step': 'Step {n}',
