  ...
  const requirementsItems: MenuEntry[] = [
    {
      id: 'r-length',
      label: '长度',
      value: LENGTH_LABELS[pref.length] ?? pref.length,
      submenu: LENGTH_OPTIONS.map(o => ({ id: o.id, label: o.label })),
    },
    {
      id: 'r-audience',
      label: '受众',
      value: AUDIENCE_LABELS[pref.audience] ?? pref.audience,
      submenu: AUDIENCE_OPTIONS.map(o => ({ id: o.id, label: o.label })),
    },
    {
      id: 'r-image',
      label: '配图',
      value: IMAGE_LABELS[pref.withImage] ?? pref.withImage,
      submenu: IMAGE_OPTIONS.map(o => ({ id: o.id, label: o.label })),
    },
    {
      id: 'r-reference',
      label: '对标',
      value: REFERENCE_LABELS[pref.reference] ?? pref.reference,
